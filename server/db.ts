    ...
    products: [
      {
        ...
        originalPrice: 5999,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1542496658-e33a6d0d50f6?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Chronos Neon Smartwatch" },
          { type: "url", url: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop", isPrimary: false, name: "Smartwatch Side View" }
        ],
        category: "Hot Deals",
      ...
      },
      {
        ...
        originalPrice: 8999,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Vortex Headphones" }
        ],
        category: "Trending",
        subCategory: "Electronics",
        rating: 4.9,
      ...
      },
      {
        ...
        originalPrice: 1999,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1627123424574-724758594e93?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Noir Wallet" }
        ],
        category: "General",
      ...
      },
      {
        ...
        originalPrice: 4999,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Aero Running Shoes" }
        ],
        category: "Trending",
        subCategory: "Sports",
        rating: 4.6,
      ...
      },
      {
        ...
        originalPrice: 1299,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Vitamin C Serum" }
        ],
        category: "Hot Deals",
        subCategory: "Beauty",
        rating: 4.4,
      ...
      {
        id: "prod_6",
        name: "Elysian Ceramic Coffee Dripper",
        description: "Artisanal double-walled heat-retaining ceramic dripper. Perfect for brewing barista-grade pour-over coffee. Promotes balanced extraction for a smoother, richer profile with standard conical filters.",
        price: 1299,
        originalPrice: 2499,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Coffee Dripper" }
        ],
        category: "General",
        subCategory: "Home",
        rating: 4.7,
        ...
        stock: 25,
        delivery: "Delivery in 3 days",
        warranty: "Shatter-Resistant Ceramic Quality",
        seller: "Elysian Brew Co.",
        specifications: {
          "Material": "Double-Walled Kiln Ceramic",
          "Capacity": "1-4 Cups",
          "Filter Type": "V60 Conical Paper Filters",
          "Dishwasher Safe": "Yes"
        },
        reviewsList: []
      },
      {
        id: "prod_7",
        name: "Atomic Habits - Hardcover Premium",
        description: "The multi-million copy bestseller by James Clear. An incredibly practical guide that teaches easy ways to build good habits and break bad ones, drawing on proven scientific principles of behavioral psychology.",
        price: 499,
        originalPrice: 799,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "James Clear Atomic Habits" }
        ],
        category: "Trending",
        subCategory: "Books",
        rating: 4.9,
        ...
        stock: 80,
        delivery: "Delivery in 2 days",
        warranty: "100% Original Paperback Edition",
        seller: "Readings Bookstore",
        specifications: {
          "Author": "James Clear",
          "Pages": "320 Pages",
      ...
      },
      {
        ...
        description: "Directly imported from Uji, Kyoto. Ceremonial grade pure organic green tea matcha stone-ground to perfection. Packed with incredible antioxidants, ready for authentic tea ceremonies or healthy lattes.",
        price: 1499,
        originalPrice: 2499,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Ceremonial Matcha Powder" }
        ],
        category: "Hot Deals",
        ...
        stock: 50,
        delivery: "Delivery in 3 days",
        warranty: "FSSAI & USDA Organic Certified",
        seller: "Kyoto Organic Imports",
        specifications: {
          "Weight": "100g Zip-Lock Pouch",
          "Origin": "Kyoto, Japan",
          "Grade": "Uji Ceremonial Grade",
      ...
      {
        id: "prod_9",
        name: "Prism Sleek Fit Cotton Blazer",
        description: "A tailored premium blazer made from breathable organic cotton linen. Styled with subtle lapels and premium resin buttons. Perfect for semi-formal brunches or important business meets.",
        price: 3499,
        originalPrice: 6999,
        images: [
          { type: "url", url: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600&auto=format&fit=crop", isPrimary: true, name: "Tailored Cotton Blazer" }
        ],
        category: "Trending",
        subCategory: "Fashion",
        rating: 4.6,
        ...
        warranty: "Color-Fastness & Fabric Quality Assured",
        seller: "Prism Clothing Hub",
        specifications: {
          "Fabric": "70% Organic Cotton, 30% Linen Blend",
          "Fit": "Tailored Sleek Fit",
          "Collar Style": "Notched Lapel",
          "Pockets": "2 Front Flap, 1 Internal Chest"
        },
        reviewsList: []
      }
    ],
